...
export default function Card() {
  ...
  return (
    <div className="relative bottom-44 flex w-card-lg flex-col gap-6 rounded-2.5xl bg-white p-6 shadow-card md:bottom-64 md:gap-8 md:p-8 xl:absolute xl:bottom-auto xl:left-[38rem] xl:top-32 xl:w-card-md">
